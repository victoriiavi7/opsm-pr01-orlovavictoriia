...
> Як мені правильно додати посилання на файли з результатами команд у README.md?

**Промпт 2:**

> Допоможи мені написати висновки до цієї практичної роботи на основі того, що я виконала.
